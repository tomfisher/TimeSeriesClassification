 ...
 */
public class ShapeletTransformDistCaching extends FullShapeletTransform
{
    ...
    public Instances process(Instances dataInst) throws Exception
    {
        ...
        { // shapelets discovery has not yet been caried out, so do so
            ...
            if (roundRobin)
            {
                ...
                dataInst = roundRobinData(dataInst, dataSourceIDs);
            }
            else
            {
            ...
            if (roundRobin)
            {
                resetDataOrder(dataInst, dataSourceIDs);
    ...
    public static class Stats
    {
        ...
        private double[][] computeCummSums(double[] currentSeries)
        {
            ...
            {
                if (i == 0)
                { //Arrays have left margin of zero
